...
public class TODOPC {
 ...
 // Método para obtener una cadena no vacía
    ...
    // Método para obtener un número decimal válido (double)
    ...
    public static void registrarEquipo() {
        ...
        int memoria = obtenerNumeroValido("Ingrese la memoria (GB):");
        ...
        switch (tipoEquipo) {
            case 0:  // Desktop
                ...
                equipos.add(new Desktop(fabricante, modelo, microprocesador, memoria, tarjetaGrafica, capacidadDiscoDuro));
                ...
                for (Equipo equipo : equipos) {
                    if (equipo instanceof Desktop) {
                        ...
                        salida.append("Fabricante: ").append(info[0]).append("\n")
                                ...
                                .append("Memoria: ").append(info[3]).append("\n")
